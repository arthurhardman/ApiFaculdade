...
namespace SistemaFaculdade.Dominio.Professores.Entidades;
...
public class Professor
{
    ...
    public Professor(string nome, string email, string senha, Endereco endereco, string cep, string numero, string adicional)
    {
        SetNome(nome);
        SetEmail(email);
        SetSenha(senha);
